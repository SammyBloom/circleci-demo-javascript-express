...
This project was built from a MERN (Mongo, Express, React, NodeJS) Starter kit (original URLs broken). Discussions still [active here](https://hashnode.com/n/mern). MERN is Mongo, Express, React and NodeJS.
